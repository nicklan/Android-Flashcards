...
public class MoreRussianSuperliminal extends CSVColFilter {

	private static int[] outOrder = {1,0};

	public MoreRussianSuperliminal() 
		throws Exception {
	...
	public String filterLine(String in,int lineNum) {
		if (lineNum == 1) 
			return "\"More Russian Words\",\"Words of importance 5 from Melinda Green's list of Russian vocabulary.  See: www.superliminal.com\"\n";
		else
			return 
