...
public class ExpandedRussianSuperliminal extends CSVColFilter {

	private static int[] outOrder = {1,0};

	public ExpandedRussianSuperliminal() 
		throws Exception {
	...
	public String filterLine(String in,int lineNum) {
		if (lineNum == 1) 
			return "\"Expanded Russian Words\",\"Words of importance 6 and 7 from Melinda Green's list of Russian vocabulary.  See: www.superliminal.com\"\n";
		else
			return 
